    ...
    <div className="text-center py-16 max-w-md mx-auto px-4">
      ...
      <section className="text-left border border-s2/40 bg-white p-5 mb-8">
        ...
        <p className="text-xs text-n1 leading-relaxed mb-3">
          注文状況は注文番号とお電話番号でご確認いただけます。
          変更・受け取りに関するご相談は LINE またはメールでお問い合わせください。
        </p>
        <div className="flex flex-col gap-2">
          <Link
            href="/shop/orders/lookup"
            className="block text-center px-4 py-2.5 bg-p2 text-p1 text-sm tracking-widest hover:bg-p3 transition-colors"
          >
            注文を確認する
          </Link>
          <a
            ...
            className="block text-center px-4 py-2.5 border border-p2 text-p2 text-sm hover:bg-p2 hover:text-p1 transition-colors"
          >
            LINE でお問い合わせ
          </a>
        </div>
