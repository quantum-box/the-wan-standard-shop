    ...
    <div className="text-center py-16 max-w-md mx-auto px-4">
      ...
      <section className="text-left border border-s2/40 bg-white p-5 mb-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Link href="/contact" className="block text-center px-4 py-2.5 border border-p2 text-p2 text-sm hover:bg-p2 hover:text-p1 transition-colors">お問い合わせ方法を見る</Link>
          <a href={LINE_URL} target="_blank" rel="noopener noreferrer" className="block text-center px-4 py-2.5 border border-s2 text-n1 text-sm hover:border-p2 hover:text-p2 transition-colors">LINE で問い合わせる</a>
        </div>
      </section>
